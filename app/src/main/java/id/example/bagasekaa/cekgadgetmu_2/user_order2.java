...
public class user_order2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_order2);

        list_harga = (ListView) findViewById(R.id.listharga);

        Intent intent = getIntent();
        id_order = intent.getStringExtra(user_order.ORDER_ID);
        ...
        databaseReference.orderByChild("id_order")
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot s : dataSnapshot.getChildren()){
                    ...
                    day = s.child("arrival").child("day").getValue(Integer.class);
                    month = s.child("arrival").child("month").getValue(Integer.class);
                    year = s.child("arrival").child("year").getValue(Integer.class);
                    //hour = s.child("arrival").child("hour").getValue(Integer.class);
                    //minute = s.child("arrival").child("minute").getValue(Integer.class);
    ...
    public void list_harga_barang(){
        ...
        FirebaseDatabase.getInstance().getReference()
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                //creating adapter
                CustomAdapter3 artistAdapter = new CustomAdapter3(user_order2.this, listdata);
